...
2.  构造请求消息并发送
    ...
    1.  请求行
        ...
        GET https://Endpoint/v1/\{project\_id\}/ats/applications

        Endpoint 为APM的Endpoint，此处以_**apm\_Endpoint**_代替。

        \{project\_id\}为路径参数

        <a name="t8d41be8dc97847dbbdcd3cc5bcb05db0"></a>
        <table><thead align="left"><tr id="r5bf8ecc3f38847489f35bdba8045e841"><th class="cellrowborder" valign="top" width="33%" id="mcps1.1.4.1.1"><p id="ab3050fbf182741c3bf3c8ca0bdb070cc"><a name="ab3050fbf182741c3bf3c8ca0bdb070cc"></a><a name="ab3050fbf182741c3bf3c8ca0bdb070cc"></a>参数</p>
        </th>
        <th class="cellrowborder" valign="top" width="33%" id="mcps1.1.4.1.2"><p id="a1e4e7c14085a4887b4c9a1ec8b88f6e2"><a name="a1e4e7c14085a4887b4c9a1ec8b88f6e2"></a><a name="a1e4e7c14085a4887b4c9a1ec8b88f6e2"></a>参数类型</p>
        </th>
        <th class="cellrowborder" valign="top" width="34%" id="mcps1.1.4.1.3"><p id="a56f7dca96527405ca061f0da335a39a3"><a name="a56f7dca96527405ca061f0da335a39a3"></a><a name="a56f7dca96527405ca061f0da335a39a3"></a>描述</p>
        </th>
        </tr>
        </thead>
        <tbody><tr id="r67acd9a234bc43a2804023da22c96dc8"><td class="cellrowborder" valign="top" width="33%" headers="mcps1.1.4.1.1 "><p id="zh-cn_topic_0082840620_p142618296479"><a name="zh-cn_topic_0082840620_p142618296479"></a><a name="zh-cn_topic_0082840620_p142618296479"></a>project_id</p>
        </td>
        <td class="cellrowborder" valign="top" width="33%" headers="mcps1.1.4.1.2 "><p id="ac04daf6346a04be6b9cfb7d8d28e910f"><a name="ac04daf6346a04be6b9cfb7d8d28e910f"></a><a name="ac04daf6346a04be6b9cfb7d8d28e910f"></a>string</p>
        </td>
        ...
        用户Token认证过程中，请求响应成功后在响应消息体中包含\{project\_id\}值，_**"id":"12ff18574dfe4b92......"**_。
