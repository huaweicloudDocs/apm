...
GET /v1/\{project\_id\}/atps/monitorgroups

## 请求消息<a name="sec7cf063544f4fb788dbeb33ef4cf3c2"></a>

**路径参数**

路径参数如[表1](#table829317653318)所示。
...
<tbody><tr id="row029316193316"><td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.1 "><p id="p14604748183317"><a name="p14604748183317"></a><a name="p14604748183317"></a>project_id</p>
</td>
...
-   正常
    ...
    状态码如[表3 状态码](#t3d66b2df3aad4b698b56acda550ecfab)所示。    
