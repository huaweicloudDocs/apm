...
2.  单击“接入应用”，进入接入应用页面。
    ...
    **图 1**  接入应用<a name="fig87285314537"></a>  
    ![](figures/接入应用.png "接入应用")

3.  单击安装命令后的![](figures/icon-copy.png)复制安装命令，然后在需要接入APM机器的任意目录执行。

    **图 2**  复制安装命令<a name="fig1191220491546"></a>  
    ![](figures/复制安装命令.png "复制安装命令")

4.  单击参数命令后的![](figures/icon-copyanzhuang.png)复制参数命令，将该参数添加到服务启动脚本的java命令。
5.  重启应用。
