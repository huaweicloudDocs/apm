...
2.  开通APM2.0免费公测版本。
    1.  登录华为云管理控制台。
    2.  单击左侧![](figures/icon-mune.png)，选择“管理与监管 \> 应用性能管理 APM”进入APM服务页面。
    3.  单击右上角“点击体验新版”进入APM2.0服务页面。

        **图 1**  体验APM2.0<a name="fig168815435521"></a>  
        ![](figures/体验APM2-0.png "体验APM2-0")
