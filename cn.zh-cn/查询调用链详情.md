...
## 功能介绍<a name="zh-cn_topic_0082840624_section157552044155617"></a>

根据调用链的traceId信息查询调用链详情。

## URI<a name="zh-cn_topic_0082840624_section2756544165618"></a>

GET /v1/\{projectId\}/ats/spans

## 请求消息<a name="zh-cn_topic_0082840624_section175634410563"></a>
...
请求参数如[表2 请求参数](#zh-cn_topic_0082840624_table33854078174211)所示。

**表 2**  请求参数

<a name="zh-cn_topic_0082840624_table33854078174211"></a>
<table><thead align="left"><tr id="zh-cn_topic_0082840624_row18649030174211"><th class="cellrowborder" valign="top" width="16.38%" id="mcps1.2.6.1.1"><p id="zh-cn_topic_0082840624_p34176474174211"><a name="zh-cn_topic_0082840624_p34176474174211"></a><a name="zh-cn_topic_0082840624_p34176474174211"></a>参数</p>
</th>
<th class="cellrowborder" valign="top" width="15.879999999999999%" id="mcps1.2.6.1.2"><p id="zh-cn_topic_0082840624_p16830973174211"><a name="zh-cn_topic_0082840624_p16830973174211"></a><a name="zh-cn_topic_0082840624_p16830973174211"></a>是否必选</p>
</th>
<th class="cellrowborder" valign="top" width="15.040000000000001%" id="mcps1.2.6.1.3"><p id="zh-cn_topic_0082840624_p21131610174211"><a name="zh-cn_topic_0082840624_p21131610174211"></a><a name="zh-cn_topic_0082840624_p21131610174211"></a>取值类型</p>
</th>
<th class="cellrowborder" valign="top" width="26.919999999999998%" id="mcps1.2.6.1.4"><p id="zh-cn_topic_0082840624_p33938839174211"><a name="zh-cn_topic_0082840624_p33938839174211"></a><a name="zh-cn_topic_0082840624_p33938839174211"></a>取值范围</p>
</th>
<th class="cellrowborder" valign="top" width="25.779999999999998%" id="mcps1.2.6.1.5"><p id="zh-cn_topic_0082840624_p64691420174211"><a name="zh-cn_topic_0082840624_p64691420174211"></a><a name="zh-cn_topic_0082840624_p64691420174211"></a>描述</p>
</th>
</tr>
</thead>
<tbody><tr id="zh-cn_topic_0082840624_row5513682174211"><td class="cellrowborder" valign="top" width="16.38%" headers="mcps1.2.6.1.1 "><p id="zh-cn_topic_0082840624_p44815917433"><a name="zh-cn_topic_0082840624_p44815917433"></a><a name="zh-cn_topic_0082840624_p44815917433"></a>traceId</p>
</td>
...
<td class="cellrowborder" valign="top" width="15.040000000000001%" headers="mcps1.2.6.1.3 "><p id="zh-cn_topic_0082840624_p17484169134311"><a name="zh-cn_topic_0082840624_p17484169134311"></a><a name="zh-cn_topic_0082840624_p17484169134311"></a>string</p>
</td>
<td class="cellrowborder" valign="top" width="26.919999999999998%" headers="mcps1.2.6.1.4 "><p id="zh-cn_topic_0082840624_p3486129184319"><a name="zh-cn_topic_0082840624_p3486129184319"></a><a name="zh-cn_topic_0082840624_p3486129184319"></a>从查询的调用链数据中获取</p>
</td>
<td class="cellrowborder" valign="top" width="25.779999999999998%" headers="mcps1.2.6.1.5 "><p id="zh-cn_topic_0082840624_p1848889134315"><a name="zh-cn_topic_0082840624_p1848889134315"></a><a name="zh-cn_topic_0082840624_p1848889134315"></a>调用链的ID</p>
</td>
</tr>
</tbody>
</table>
...
## 响应消息<a name="zh-cn_topic_0082840624_section1476184425619"></a>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p263985273"><a name="p263985273"></a><a name="p263985273"></a>list(string),数据结构参见(<a href="#apm_04_0016__table22213312082">表4 spans字段数据结构说明</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p418819405818"><a name="p418819405818"></a><a name="p418819405818"></a>调用的起始时间(单位us)</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p1204540189"><a name="p1204540189"></a><a name="p1204540189"></a>Span调用耗时(单位us)</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p15204154017813"><a name="p15204154017813"></a><a name="p15204154017813"></a>list(string)，数据结构参见(<a href="#apm_04_0016__table8516510297">表5 Annotation字段数据结构说明</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p62201440786"><a name="p62201440786"></a><a name="p62201440786"></a>list(string)，数据结构参见(<a href="#apm_04_0016__table191758711100">表6 BinarryAnnotation字段数据结构说明</a>)</p>
</td>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.3 "><p id="p9236520492"><a name="p9236520492"></a><a name="p9236520492"></a>某事件发生的本地当前系统时间(单位us)</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p11252122016912"><a name="p11252122016912"></a><a name="p11252122016912"></a>数据结构参见<a href="#apm_04_0016__table12910249191010">表7 EndPoint字段数据结构说明</a></p>
</td>
...
<td class="cellrowborder" valign="top" width="33.33333333333333%" headers="mcps1.2.4.1.2 "><p id="p18154173105"><a name="p18154173105"></a><a name="p18154173105"></a>数据结构参见<a href="#apm_04_0016__table12910249191010">表7</a></p>
</td>
...
## 状态码<a name="zh-cn_topic_0082840624_section2805184414561"></a>

-   正常

    状态码如[表8 状态码](#zh-cn_topic_0082840624_table54811320178)所示。   

    **表 8**  状态码

    <a name="zh-cn_topic_0082840624_table54811320178"></a>
    <table><thead align="left"><tr id="zh-cn_topic_0082840624_row2481233171"><th class="cellrowborder" valign="top" width="50%" id="mcps1.2.3.1.1"><p id="zh-cn_topic_0082840624_p11481143171713"><a name="zh-cn_topic_0082840624_p11481143171713"></a><a name="zh-cn_topic_0082840624_p11481143171713"></a>状态码</p>
    </th>
    ...
    <tbody><tr id="zh-cn_topic_0082840624_row0481183201712"><td class="cellrowborder" valign="top" width="50%" headers="mcps1.2.3.1.1 "><p id="zh-cn_topic_0082840624_p13481203201711"><a name="zh-cn_topic_0082840624_p13481203201711"></a><a name="zh-cn_topic_0082840624_p13481203201711"></a>200</p>
    </td>
