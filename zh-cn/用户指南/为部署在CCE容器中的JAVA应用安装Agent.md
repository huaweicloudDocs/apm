...
-   选择“系统管理 \> 访问密钥”进入访问密钥页面，查看获取接入javaagent所需的AK/SK。
    ...
    **图 1**  获取AK/SK<a name="fig89719591559"></a>  
    ![](figures/获取AK-SK-0.png "获取AK-SK-0")
...
3.  在对应界面列表中可通过右上角过滤框筛选，找到要部署Agent的JAVA应用。
    ...
    **图 2**  查找JAVA应用<a name="fig2091714164566"></a>  
    ![](figures/查找JAVA应用.png "查找JAVA应用")
...
2.  在“性能管理配置”卡片查看“JAVA探针”是否被勾选，如图[图1 查看JAVA探针](#fig32632311686)所示。
    ...
    **图 3**  查看JAVA探针<a name="fig32632311686"></a>  
...
1.  <a name="li77091261911"></a>单击“性能管理配置”卡片下的“编辑”，去掉勾选，单击“重启实例”，在提示弹框中单击“我知道了”。完成重启实例，此时APM1.0探针已被卸载。
    ...
    **图 4**  重启实例<a name="fig878994411563"></a>  
    ![](figures/重启实例.png "重启实例")

    **图 5**  重启实例提示<a name="fig121183318493"></a>  
    ![](figures/重启实例提示.png "重启实例提示")


1.  <a name="li165532037104713"></a>在应用详情页面，单击“编辑YAML”，单击“下载”，将yaml文件下载到本地。

    **图 6**  编辑YAML文件<a name="fig9766655125616"></a>  
    ![](figures/编辑YAML文件.png "编辑YAML文件")
...
4.  服务重新启动完成后，Agent的加载完成，重新加载后的状态为“运行中”，如下图所示。
    ...
    **图 7**  查看Agent状态<a name="fig898819122571"></a>  
    ![](figures/查看Agent状态.png "查看Agent状态")
